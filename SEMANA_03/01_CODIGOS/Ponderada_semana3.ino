...
void tocarMelodiaGanhou() {
  playMelody(melodiaGanhou);
}

void tocarMelodiaPerdeu() {
  playMelody(melodiaPerdeu);
}
...
tocarMelodiaGanhou(); // Toca a melodia "Ganhou"
}